...
import com.example.androidmessendger.domain.repositories.rest.RestClient
import com.example.androidmessendger.domain.repositories.rest.TokenInterceptor
...
class NetModule {
    ...
    fun provideOkHttpClientWithOutTokenInterceptor(logger: Interceptor): OkHttpClient = OkHttpClient.Builder().apply {
